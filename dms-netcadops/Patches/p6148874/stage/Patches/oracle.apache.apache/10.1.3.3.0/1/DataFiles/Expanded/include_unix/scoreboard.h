...
#ifdef DMS2
/*
 * we set DMS_SERVER_LIMIT separate from HARD_SERVER_LIMIT so that we
 * don't waste extra mem due to large settings of HARD_SERVER_LIMIT.
 * TODO: let DMS_SERVER_LIMIT vary with MaxClients
 */
#endif /* DMS2 */
