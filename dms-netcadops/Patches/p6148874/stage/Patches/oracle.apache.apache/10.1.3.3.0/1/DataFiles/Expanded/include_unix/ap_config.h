...
/*
 * BUG1372870: For A_OSF we need to include string.h before types.h which 
 * includes select.h to avoid the conflict in the definition of bzero
 */
#if defined(A_OSF)
#include <string.h>
#endif
...
#define NONBLOCK_WHEN_MULTI_LISTEN
#ifdef AIXRIOS
/* build flag: -DAIX_BIND_PROCESSOR */
#ifndef AIX_BIND_PROCESSOR
#define AIX_BIND_PROCESSOR 1
#endif
