...
#else
#define HARD_SERVER_LIMIT 8192  /* bug #1326139, #2127404 */
#endif
#endif
...
#define DEFAULT_LIMIT_REQUEST_FIELDSIZE 204750
#define IDEAL_LIMIT_REQUEST_FIELDSIZE 8190 
...
#define SERVER_BASEPRODUCT  "Oracle-HTTP-Server"
...
#define PARENT_PRODUCT "Oracle-Application-Server-10g"
#define PARENT_PRODUCTREVISION "10.1.3.1.0"
#define SERVER_PRODUCTVERSION PARENT_PRODUCT "/" PARENT_PRODUCTREVISION \
" " SERVER_BASEPRODUCT

#include "ap_oracle_version.h"

#define OPMN_UID_CTXNAME   "opmn_unique_id"

enum server_token_type {
    SrvTk_MIN,		/* eg: Oracle10g/9.0.4 Oracle HTTP Server */
    SrvTk_OS,		/* eg: Oracle10g/9.0.4 Oracle HTTP Server (UNIX) */
    SrvTk_FULL,		/* eg: Oracle10g/9.0.4 Oracle HTTP Server (UNIX) PHP/3.0 FooBar/1.2b */
    SrvTk_PRODUCT_ONLY,	/* eg: Oracle10g */
    SrvTk_NONE,         /* eg: */
    SrvTk_CUSTOM        /* eg: anything you want */   
};
...
struct server_rec {
    ...
    /*
     * WARNING!  The is_ssl flag is a proprietary extension to the server_rec
     * structure made within OHS by Oracle.  It should not be used unless
     * absolutely necessary and in cases where the code will never be used
     * outside of OHS.  This field should remain at the very end of this
     * structure to ensure compatability with generic open source Apache.
     */
    int is_ssl;              /* true if this server has ssl turned on */
#ifdef WIN32
    int sjis_url;
#endif /* WIN32 */
};
...
/*
 * OHS_INDICATOR_NAME is used to define a context structure which will
 * be set if we are running within OHS.  It's used to let modules know
 * whether they will be running within OHS or generic Apache.
 */
#define OHS_INDICATOR_NAME "__oracle_this_is_ohs"

/*
 * This is the structure that is set as the context value.  Currently,
 * this context contains nothing more than the address of the 
 * ap_listeners global variable which is needed by mod_onsint.
 * Other information may be added later.
 */
typedef struct _this_is_ohs_ctx
{
...
/* Set state in parent process
 * Get state in child processes
 */
API_EXPORT(int) ap_set_state(char *name, void *value, unsigned int size);
API_EXPORT(void *) ap_get_state(char *name);
